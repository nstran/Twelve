...
const GRID_NATIVE    = 232;
const GRID_PX        = BOARD_SCALE * GRID_NATIVE;
export const GEM_SIZE          = Math.floor(GRID_PX / BOARD_COLS);
// Căn giữa board trong vùng grid của ảnh nền
export const BOARD_LEFT_OFFSET = Math.round((BG_W - GEM_SIZE * BOARD_COLS) / 2);
export const BOARD_TOP_OFFSET  = BOARD_LEFT_OFFSET;
