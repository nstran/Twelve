...
export const HAIR_STYLE_OPTIONS = {
  male: [
    { key: '501', label: 'Cổ điển', metaId: 50199, baseImageId: 50100, width: 33, height: 26, numColors: 6 },
    { key: '504', label: 'Vuốt dựng', metaId: 50499, baseImageId: 50400, width: 33, height: 31, numColors: 6 },
    { key: '505', label: 'Búi xõa', metaId: 50599, baseImageId: 50500, width: 27, height: 47, numColors: 6 },
  ],
  female: [
    { key: '500', label: 'Búi nơ', metaId: 50099, baseImageId: 50000, width: 38, height: 38, numColors: 6 },
    { key: '502', label: 'Tóc tém', metaId: 50299, baseImageId: 50200, width: 32, height: 31, numColors: 6 },
    { key: '503', label: 'Búi hai bên', metaId: 50399, baseImageId: 50300, width: 40, height: 24, numColors: 6 },
  ],
...
/** Tạm khóa hệ tóc về màu đen mặc định. */
