...
/**
 * 6 tông màu tóc — màu chính từ Java reference + bạch kim.
 * Mid-light (~18% pixels) = màu chính; shadow/highlight derive theo %.
 * Primary: #262640 (default), #DF1A14, #FF718A, #4B68D6, #3DB54E, #F0E8C0 (bạch kim)
 */
export const HAIR_COLOR_OPTIONS: ColorOption[] = [
  ...
  { label: 'Bạch kim',   swatch: '#E0E9FF', toColors: [0x222326, 0x3F4147, 0x747984, 0xE0E9FF, 0xF1F5FF] },
];
