...
Tiến độ character runtime hiện tại: status screen đã đọc runtime snapshot riêng ngoài `CHARACTER_INFO`, có thể phân điểm tiềm năng, nâng skill theo hệ, mặc/tháo trang bị, dùng item hồi HP ngoài battle. Battle bootstrap giờ lấy skill đã học thật từ aggregate để khóa panel tuyệt chiêu theo player state hiện tại.
