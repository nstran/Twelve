...
public final class cx {
    ...
    private void a(cy cy2, byte[] byArray, int n2, int[] nArray) {
        int n3 = cy2.a[0];
        int n4 = cy2.a[1];
        int n5 = cy2.a[2];
        int n6 = cy2.a[3];
    ...
    private void a(cy cy2, byte[] byArray, int n2, int n3) {
        int n4;
        this.b = null;
