...
extends al {
    ...
    public final void c(Graphics graphics) {
        ...
        int n5 = n3;
        if (this.w == 2) {
            pc.c(graphics, n4 - 25, n5 + 1, 19, 17, 857589, 0);
            pc.c(graphics, n4 + 5 + 60, n5 + 1, 19, 17, 857589, 1);
        }
        pc.a(graphics, n4, n5, 60, this.m, this.w == 2);
        bx.d.a(graphics, String.valueOf(this.r), n2 + this.v / 2, n3 + 3, 1);
        n4 = n2 + (this.v - 100) / 2;
        n5 = n3 += this.m + 2;
        if (this.w == 1) {
            pc.c(graphics, n4 - 25, n5 + 1, 19, 17, 857589, 0);
            pc.c(graphics, n4 + 5 + 100, n5 + 1, 19, 17, 857589, 1);
        }
        pc.a(graphics, n4, n5, 100, this.m, this.w == 1);
        bx.d.a(graphics, "Th\u00e1ng " + this.q, n2 + this.v / 2, n3 + 3, 1);
    ...
    private void a(Graphics graphics, int n2, int n3) {
        ...
        pc.b(graphics, n2 + 1, n3 + 1, this.v - 2, this.u - 2, n6, n7, -1);
        n6 = 0;
        int n8 = n3 + 3 + this.l;
        int n9 = n3 + this.u - 1;
        while (n8 <= n9) {
        ...
        while (n9 <= this.t) {
            ...
            bx.d.a(graphics, String.valueOf(n9), n6 + this.k - 1, n7 + 2, 2);
            ++n8;
            ++n9;
        }
    }
