        ...
        try {
            ...
            if (n4 >= 0) {
                if (this.d != null) {
                    ...
                    if (this.a == 0) {
                        cw.a(graphics, this.b, nArray[0], nArray[1], nArray[2], nArray[3], n2, n3, 0);
                        return;
                    }
                ...
                if (this.a == 0) {
                    cw.a(graphics, this.b, this.f[this.e][this.g] * this.o, 0, this.o, this.p, this.m + n2, this.n + n3, this.q);
                    return;
                }
