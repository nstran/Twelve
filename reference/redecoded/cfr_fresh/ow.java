...
public final class ow {
    ...
    public static void a(int n2, int n3, Graphics graphics) {
        ...
        ow.a(n2, n3, a, graphics);
        graphics.setColor(52479);
        graphics.drawRect(n2 + 1, n3 + 1, 228, 228);
        ow.a(n2, n3, b, graphics);
        ow.a(n2, n3, c, graphics);
        ...
        ow.a(n2 + 5, n3 + 232, graphics, false);
        ow.a(n2 + 5, n3 + 239, graphics, true);
        ow.a(n2 + 5, n3 + 246, graphics, false);
        ow.a(n2 + 149, n3 + 232, graphics, false);
        ow.a(n2 + 149, n3 + 239, graphics, true);
        ow.a(n2 + 149, n3 + 246, graphics, false);
    }

    public static void b(int n2, int n3, Graphics graphics) {
        ow.c((n2 += 19) + 29, ++n3 + 3, graphics);
        graphics.setColor(0x5A5A5A);
        graphics.fillRect(n2 + 3, n3 + 3, 24, 81);
        graphics.fillRect(n2 + 256, n3 + 3, 24, 81);
        graphics.setColor(0x9933FF);
        ow.a(n2, n3, d, graphics);
        graphics.setColor(52479);
        graphics.drawRect(n2 + 27, n3 + 1, 228, 228);
        ow.a(n2, n3, e, graphics);
        ow.a(n2, n3, f, graphics);
        graphics.setColor(230911);
        graphics.drawRect(n2 + 28, n3 + 2, 226, 226);
        graphics.drawRect(n2 + 2, n3 + 2, 25, 82);
        graphics.drawRect(n2 + 255, n3 + 2, 25, 82);
        ow.b(n2 + 5, n3 + 5, graphics, false);
        ow.b(n2 + 12, n3 + 5, graphics, true);
        ow.b(n2 + 19, n3 + 5, graphics, false);
        ow.b(n2 + 258, n3 + 5, graphics, false);
        ow.b(n2 + 265, n3 + 5, graphics, true);
        ow.b(n2 + 272, n3 + 5, graphics, false);
    }
