...
implements bf {
    ...
    public final void a(Graphics graphics, int n2, int n3) {
        pc.a(graphics, this.c() + n2, this.d() + n3, this.e(), this.f(), this.g);
        String string = "";
        ...
        n2 = n2 + this.c() + (this.e() - bx.d.a(string3)) / 2;
        if (this.g) {
            graphics.setColor(16048180);
            graphics.fillRect(n2 + bx.d.a(string) - 2, n3 + this.d() + 2, bx.d.a(string2) + 3, this.f() - 4);
        }
        bx.d.a(graphics, string3, n2, n3 + this.d() + 2, 0);
    }
