...
extends aq {
    ...
    private gc(String string, int n2, d d2, int n3) {
        this(string, 0, n2, d2, 1);
    }

    public gc(String string, int n2, d d2) {
        this(string, n2, d2, 1);
    }

    public gc(String string, int n2, int n3, d d2, int n4) {
        int n5;
        block9: {
            block8: {
                this.l = 0;
                ...
                Object object = bx.a(string, n3 - n2, d2);
                if (((String[])object).length <= 0) break block9;
                n5 = object[0].length();
                object = string.substring(n5);
                object = bx.a((String)object, n3, d2);
    ...
    public final void a(Graphics graphics, int n2, int n3) {
        ...
        if (this.f && this.m()) {
            pc.e(graphics, n2 + this.c(), n3 + this.d() + this.q / 2, this.e(), this.f());
        }
        int n4 = 0;
        int n5 = 0;
