...
implements bu {
    ...
    public final void a(Graphics var1_1, int var2_2, int var3_3) {
        ...
        cw.a(var1_1, this.p);
        cw.a(var1_1, this.p, var2_2, var3_3, this.e(), this.f());
...
lbl32:
    ...
    private boolean a(ay aq2, k object, int n2, int n3) {
        if (2 == n2) {
            if (n3 < 0) {
                if (this.s >= this.n) {
                    n2 = this.g(0, this.s / this.n);
                    if (n2 > ((k)object).b + this.j) {
                        n3 = this.s - this.n;
                        fd fd2 = this;
                        this.s = n3;
            ...
            if (n2 / this.n != this.s / this.n) {
                ...
                if (n3 + this.l + this.j < ((k)object).b + ((k)object).d) {
                    n3 = n2;
                    fd fd3 = this;
                    this.s = n3;
        ...
        if (n3 < 0) {
            if (this.s > 0) {
                ...
                if (n2 > ((k)object).a + this.i) {
                    ...
                    object = aq2;
                    aq2 = this;
                    n3 = ((fd)aq2).g(0, ((fd)aq2).s % ((fd)aq2).n);
                    if (n3 <= ((k)object2).a) {
                        int n4 = n3 - ((k)object2).a;
                        if (((fd)aq2).k >= ((k)object2).c) {
                            n4 += ((fd)aq2).k - ((k)object2).c;
                        } else if (((fd)aq2).s % ((fd)aq2).n > 0) {
                            n4 = n3 - n4 + ((fd)aq2).k + ((fd)aq2).i + ((fd)aq2).k > ((k)object2).a + ((k)object2).c ? (n4 -= ((k)object2).c - ((fd)aq2).k - ((fd)aq2).i) : (n4 -= ((fd)aq2).k);
                        }
                        ((ay)object).i(n4);
                    }
                    return true;
        ...
        if (this.s < this.o - 1) {
            ...
            n2 = this.h(0, this.s % this.n);
            if (n2 + this.k + this.i < ((k)object).a + ((k)object).c) {
                n3 = this.s + 1;
                Object object3 = this;
                this.s = n3;
                object3 = object;
                ...
                aq2 = this;
                n3 = ((fd)aq2).g(0, ((fd)aq2).s % ((fd)aq2).n);
                if (n3 + ((fd)aq2).k + ((fd)aq2).i > ((k)object3).a + ((k)object3).c) {
                    int n5 = n3 + ((fd)aq2).k + ((fd)aq2).i - (((k)object3).a + ((k)object3).c);
                    if (((fd)aq2).k >= ((k)object3).c) {
                        n5 -= ((fd)aq2).k - ((k)object3).c;
                    } else if (((fd)aq2).s % ((fd)aq2).n < ((fd)aq2).n - 1) {
                        n5 = n3 - n5 - ((fd)aq2).k - ((fd)aq2).i < ((k)object3).a ? (n5 += ((k)object3).c - ((fd)aq2).k - ((fd)aq2).i) : (n5 += ((fd)aq2).k + ((fd)aq2).i);
                    }
                    ((ay)object).i(n5);
                }
                return true;
    ...
    private void a(ay ay2, k k2) {
        int n2 = this.g(0, this.s / this.n);
        if (n2 <= k2.b) {
            int n3 = n2 - k2.b;
            if (this.l >= k2.d) {
                n3 += this.l - k2.d;
            } else if (this.s >= this.n) {
                n3 = n2 - n3 + this.l + this.j + this.l > k2.b + k2.d ? (n3 -= k2.d - this.l - this.j) : (n3 -= this.l);
            }
            ay2.j(n3);
        }
    }
    ...
    private void b(ay ay2, k k2) {
        int n2 = this.g(0, this.s / this.n);
        if (n2 + this.l + this.j > k2.b + k2.d) {
            int n3 = n2 + this.l + this.j - (k2.b + k2.d);
            if (this.l >= k2.d) {
                n3 -= this.l - k2.d;
            } else {
                int n4 = this.s + this.n;
                if (n4 >= this.o) {
                    n4 = this.o - 1;
                }
                if (n4 / this.n != this.s / this.n) {
                    n3 = n2 - n3 - this.l - this.j < k2.b ? (n3 += k2.d - this.l - this.j) : (n3 += this.l + this.j);
                }
            }
            ay2.j(n3);
        }
