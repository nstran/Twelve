        ...
        while (this.o || !MGMIDlet.d().c) {
            ...
            if (this.q == 0) {
                if (this.g < this.n) {
                    ...
                    int n2 = ((ce)object).l - ((ce)object).j / 2 - ((ce)object).g * ((ce)object).j;
                    ((ce)object).b.fillRect(0, n2, ((ce)object).e, ((ce)object).j / 2 - ((ce)object).k);
                    n2 = n2 + 10 - (((ce)object).j / 2 - ((ce)object).k);
                    ((ce)object).b.fillRect(0, n2, ((ce)object).e, ((ce)object).j / 2 - ((ce)object).k);
                    n2 = ((ce)object).l - ((ce)object).j / 2 + ((ce)object).g * ((ce)object).j;
                    ((ce)object).b.fillRect(0, n2, ((ce)object).e, ((ce)object).j / 2 - ((ce)object).k);
                    n2 = n2 + 10 - (((ce)object).j / 2 - ((ce)object).k);
                    ((ce)object).b.fillRect(0, n2, ((ce)object).e, ((ce)object).j / 2 - ((ce)object).k);
