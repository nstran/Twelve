    ...
    private void a(String string, String[] stringArray) {
        ...
        if (stringArray != null) {
            ...
            while (n4 < stringArray.length) {
                this.q[n4 + 1] = bx.a(stringArray[n4], n3 - 4, this.o);
        ...
        this.m = new k(10, 30, n3, n2 += n4 + 10);
        this.g = n2 + 65;
        this.d = v.u - this.g >> 1;
    }
    ...
    public final void c(Graphics graphics) {
        ...
        if (this.q != null) {
            ...
            while (n5 < this.q.length) {
                if (n5 > 0) {
                    pc.a(graphics, n3, n4 + n2 + this.o.a() / 2);
                }
                bx.a(graphics, this.o, this.q[n5], n3 + 10, n4 + n2, this.m.c - 10, this.m.d, 0);
