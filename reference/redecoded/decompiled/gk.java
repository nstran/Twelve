...
extends ey {
    ...
    public final void a(int n2, int n3, int n4, int n5) {
        this.d = new k(n2, n3, n4, 9 + bx.d.a());
    ...
    public final void a(Graphics graphics, int n2, int n3) {
        ...
        int n5 = (n2 += this.c()) + 4;
        bx.d.c(true);
        bx.d.a(graphics, this.i, n5, n4, 0);
        bx.d.c(false);
        n2 += this.e() - 30;
        n4 = this.f() - 6;
        n4 = (n3 += 3) + (n4 - bx.d.b()) / 2;
        ...
        switch (this.k) {
            case 0: {
                if (this.a()) {
                    pc.a(graphics, k3, 32, new int[]{0x2D2D2D}, n2 - 1, n3 - 1);
                    pc.a(graphics, k2, 30, this.l, n2, n3);
                    bx.d.a(graphics, "O", n2 + 7, n4, 1);
                    k2 = new k(0, 0, 15, k2.d);
                    pc.a(graphics, k2, 15, this.n, n2 + 15, n3);
                    break;
                }
                pc.a(graphics, k3, 32, new int[]{0x2D2D2D}, n2 - 1, n3 - 1);
                pc.a(graphics, k2, 30, this.m, n2, n3);
                bx.d.a(graphics, "I", n2 + 22, n4, 1);
                k2 = new k(0, 0, 15, k2.d);
                pc.a(graphics, k2, 15, this.n, n2, n3);
                break;
            }
            default: {
                if (this.a()) {
