...
extends aq {
    ...
    public gf(String string) {
        ...
        this.m = new k(this.k + 4, n2, v.t, this.k);
    ...
    public final void a(Graphics graphics, int n2, int n3) {
        ...
        n3 += this.d();
        if (this.n != null) {
            bx.d.a(graphics, this.n, n2, n3, 0);
        }
        cw.a(graphics, this.j, this.m() ? (this.k << 1) + this.k : this.k << 1, 0, this.k, this.k, this.m.a - 4 + n2, this.m.b + n3, 24);
        cw.a(graphics, this.j, this.m() ? this.k : 0, 0, this.k, this.k, this.m.a + this.m.c + 4 + n2, this.m.b + n3, 20);
    ...
    public final boolean c(int n2, int n3) {
        if (new k(this.m.a - 4 - this.k, this.m.b, this.k, this.k).a(n2 -= this.c(), n3 -= this.d())) {
            this.h(this.i - 10);
            return true;
        }
        if (new k(this.m.a + this.m.c + 4, this.m.b, this.k, this.k).a(n2, n3)) {
            this.h(this.i + 10);
            return true;
        }
        if (this.m.a(n2, n3)) {
