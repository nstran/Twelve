...
extends at {
    ...
    public mx(ms object, k object2, byte by2, int n2, int n3) {
        this.b = object;
        this.G = ((ms)object).a();
        this.K = object2;
        this.y = new int[2];
        ...
        try {
            ...
            int n4 = 0;
            while (n4 < ((mx)object2).H.length) {
                ((mx)object2).H[n4] = mx.b(((mx)object2).G[0][n4].a(), 0);
                ++n4;
            }
            n4 = 0;
            while (n4 < ((mx)object2).I.length) {
                try {
                    ((mx)object2).I[n4] = ((mx)object2).G[1][n4].b() && ((mx)object2).G[1][n4].a().Y > 0 ? super.a(((mx)object2).G[1][n4].a(), 1) : mx.b(((mx)object2).G[1][n4].a(), 1);
                }
                catch (Exception exception) {
                    Exception exception2 = exception;
                    exception.printStackTrace();
                    System.err.println(((mx)object2).G[1][n4]);
                }
                ++n4;
            }
        ...
        this.u = new nc[25];
        int n6 = mp.a().b.getWidth() / 6;
        n3 = mp.a().b.getHeight() / 9;
        int n7 = 1 * n3;
        int n8 = 0;
        while (n8 < this.u.length) {
            this.u[n8] = new nc(mp.a().b, n6, n3, n7);
        ...
        while (n8 < this.v.length) {
            this.v[n8] = new nc(mp.a().b, n6, n3, n7);
        ...
        while (n8 < this.P.length) {
            this.P[n8] = new mi(n6, this.G[n8][0].l());
        ...
        while (n8 < this.Q.length) {
            this.Q[n8] = new mi(n6, this.G[n8][0].o());
        ...
        while (n8 < this.R.length) {
            this.R[n8] = new mi(n6, this.G[n8][0].r());
            this.R[n8].a(0, this.G[n8][0].q(), this.G[n8][0].r(), 0);
            ++n8;
        }
        if (oq.o == 1) {
            this.S = new mi(n6, ((ms)object).g);
            n6 = 1;
            object = this.S;
            this.S.b = n6;
            this.c = new np();
    ...
    private static Image m(int n2) {
        return pa.a().a(n2, false);
    }

    private nk a(lh lh2, int n2) {
        Image image;
        int n3 = lh2.Y;
        Object object = mx.m(n3 + 5);
        Image image2 = mx.m(n3 + 1);
        Image image3 = mx.m(n3 + 4);
        Image image4 = image = mx.m(n3 + 3);
        Image image5 = mx.m(n3 + 6);
    ...
    private static nk b(lh object, int n2) {
        try {
            ...
            ((mg)object).a(lc2);
            ((mg)object).a(nr2);
            return new ni(n2, mg2, mg4, mg3, mg5, mg6, mg7, (mc)object, nr2);
        }
        catch (Exception exception) {
            Exception exception2 = exception;
            exception.printStackTrace();
    ...
    public final void i() {
        ...
        if (this.S != null) {
            n3 = com.mg.sq.a.k == 0 ? this.E.getWidth() : this.E.getHeight();
    ...
    public final void a(int n2, int n3) {
        lg lg2 = this.G[n2][this.N[0]];
        int n4 = n2 = n2 == 0 ? 1 : 4;
        if (this.A == 0) {
            int n5 = this.B[n2][0] + this.C[0].getWidth() * lg2.n() / lg2.o();
            n2 = this.B[n2][1] + this.B[n2][3] / 2;
            int n6 = 0;
            while (n6 < this.v.length) {
                if (!this.v[n6].m()) {
                    this.v[n6].a(n5, n2, n5 - 5 + cv.a(80), n2 + cv.a() % 100, 10);
                    this.v[n6].a(cv.a(10));
                }
                ++n6;
            }
        ...
        n2 = this.B[n2][1] + (lg2.o() - lg2.n()) * this.D.getHeight() / lg2.o();
        int n8 = 0;
        while (n8 < this.v.length) {
            if (!this.v[n8].m()) {
                this.v[n8].a(n7, n2, n7 + cv.a() % 100, n2 + 5 - cv.a(80), 10);
                this.v[n8].a(cv.a(10));
            }
            ++n8;
        }
    ...
    public final void a(int n2, int n3, boolean bl2) {
        ...
        int n5 = 15;
        if (this.A == 0) {
            int n6 = this.B[n4][0] + this.C[0].getWidth() * lg2.m() / lg2.l();
            int n7 = this.B[n4][1] + this.B[n4][3] / 2;
            n4 = 0;
            while (n4 < this.u.length) {
                if (!this.u[n4].m()) {
                    this.u[n4].a(n6, n7, n6 - 5 + cv.a(80), n7 + cv.a() % 100, n3);
                    this.u[n4].a(cv.a(10));
                    if (--n5 <= 0) break;
                }
                ++n4;
            ...
            int n9 = this.B[n4][1] + (lg2.l() - lg2.m()) * this.C[0].getHeight() / lg2.l();
            n4 = 0;
            while (n4 < this.u.length) {
                if (!this.u[n4].m()) {
                    this.u[n4].a(n8, n9, n8 + cv.a() % 100, n9 + 5 - cv.a(80), n3);
                    this.u[n4].a(cv.a(10));
                    if (--n5 <= 0) break;
                }
                ++n4;
