        ...
        try {
            ...
            while (n7 < n8) {
                if (byArray[n7] == 80 && byArray[n7 + 1] == 76 && byArray[n7 + 2] == 84 && byArray[n7 + 3] == 69) {
                    n3 = n7;
                    n2 = m.a(byArray[n7 - 4], byArray[n7 - 3], byArray[n7 - 2], byArray[n7 - 1]);
                    break;
                }
                ++n7;
            }
            ...
            while (n6 < objectArray.length) {
                n5 = (byte)(objectArray[n6] >> 16 & 0xFF);
                by3 = (byte)(objectArray[n6] >> 8 & 0xFF);
                by2 = (byte)objectArray[n6];
                int n9 = n4 = n3 + 4;
                int n10 = n2 + n4;
                while (n9 < n10) {
                    if ((n9 - n4) / 3 != n7 && blArray[(n9 - n4) / 3] && byArray[n9] == n5 && byArray[n9 + 1] == by3 && byArray[n9 + 2] == by2) {
                        byArray[n9] = (byte)(nArray[n6] >> 16 & 0xFF);
                        byArray[n9 + 1] = (byte)(nArray[n6] >> 8 & 0xFF);
                        byArray[n9 + 2] = (byte)nArray[n6];
            ...
            n6 = 0;
            while (n6 < n2 + 4) {
                objectArray[n6] = byArray[n3 + n6];
                ++n6;
            }
            e.a();
            long l2 = e.a((byte[])objectArray);
            by3 = 3;
            while (by3 >= 0) {
        ...
        try {
            ...
            while (n10 < n11) {
                if (byArray[n10] == 80 && byArray[n10 + 1] == 76 && byArray[n10 + 2] == 84 && byArray[n10 + 3] == 69) {
                    n4 = n10;
                    n3 = m.a(byArray[n10 - 4], byArray[n10 - 3], byArray[n10 - 2], byArray[n10 - 1]);
                    break;
                }
                ++n10;
            }
            ...
            try {
                ...
                if (byArray[n11] == 116 && byArray[n11 + 1] == 82 && byArray[n11 + 2] == 78 && byArray[n11 + 3] == 83) {
                    n10 = m.a(byArray[n11 - 4], byArray[n11 - 3], byArray[n11 - 2], byArray[n11 - 1]);
                    --n10;
                }
            }
            catch (Exception exception) {
        ...
        try {
            ...
            while (n8 < n9) {
                if (byArray[n8] == 80 && byArray[n8 + 1] == 76 && byArray[n8 + 2] == 84 && byArray[n8 + 3] == 69) {
                    n3 = n8;
                    n2 = m.a(byArray[n8 - 4], byArray[n8 - 3], byArray[n8 - 2], byArray[n8 - 1]);
                    break;
                }
                ++n8;
            }
            ...
            try {
                ...
                if (byArray[n9] == 116 && byArray[n9 + 1] == 82 && byArray[n9 + 2] == 78 && byArray[n9 + 3] == 83) {
                    n8 = m.a(byArray[n9 - 4], byArray[n9 - 3], byArray[n9 - 2], byArray[n9 - 1]);
                    --n8;
                }
            }
            catch (Exception exception) {
