...
When coding the new create-character flow:

- start from `00_ui_confirmed`
- then port `01_core_compositor`
- only after preview parity is working should `02_option_meta_families` be promoted from candidate status
